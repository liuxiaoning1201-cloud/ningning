<template>
  <div class="page">
    <nav class="nav-bar">
      <RouterLink to="/settings" class="btn btn-secondary">← 詞句庫列表</RouterLink>
    </nav>
    ...
    <div class="card" style="margin-bottom: 1rem">
      ...
      <p class="muted" style="margin-bottom: 0.5rem">上傳 .xlsx、.csv 或 .txt，第一欄為詞句、第二欄釋義（可選）、第三欄出處（可選）。</p>
    ...
    <div class="card" style="margin-bottom: 1rem">
      ...
      <table v-if="items.length > 0" class="word-table">
        <thead>
          <tr><th>詞句</th><th>釋義</th><th>出處</th><th></th></tr>
        </thead>
        <tbody>
