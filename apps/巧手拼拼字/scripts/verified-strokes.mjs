...
/**
 * 小學高頻字：打進 chars.json 後課堂不必等 CDN。
 * 筆畫種類仍由分類器現場補，不標 verified。
 */
export const PRIMARY_BUNDLE = [
  ...'進之這陰陽那龜龍馬鳥魚花草蟲貓雞兔車開國香港爸媽愛看聽讀寫來校師你他她的是有在不多美地春夏秋冬風雨東西南北頭身走跑跳坐立見時年課問知字詞句歌圖紅黃藍綠長短高低輕重快慢新舊冷熱早晚今明星期星雲樹葉河海船橋路食飯菜茶帽鞋窗床桌椅書筆紙園場樂喜怒哭笑起睡洗玩遊朋友自己誰什麼裏後前從到和與可以會能要想再還就沒很太最因為所以但是如果然後開始完成練習功課學生同學學校哥姐弟妹孫祖',
];
